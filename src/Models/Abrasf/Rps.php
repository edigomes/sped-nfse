...
class Rps extends RpsBase
{
     ...
     * @var array
     */
    public $infPrestador = ['tipo' => '', 'cnpjcpf' => '' , 'im' => '', 'razao' => '', 'tel' => '','email' => ''];
    /**
     * @var array
     */
     ...
     * @param int $cep
     */
    public function prestadorEndereco($end, $numero, $complemento, $bairro, $cmun, $uf, $cep)
    {
     ...
     * @throws InvalidArgumentException
     */
    public function codigoMunicipio($value)
    {
        $value = trim($value);
        if (!Validator::stringType()->length(7)->validate($value)) {
            throw new \InvalidArgumentException('O codigo do município é obrigatório e deve ter '
                    . '7 caracteres.');
        }
